  ...
  hero: {
    heading: (
      <>
        ...
        <span className="text-primary"> Home Education</span> Since 2017
Serving Mumbai, Navi Mumbai, Thane, and Ghodbunder Road
      </>
    ),
    description:
      "We offer expert tutors for all boards including CBSE, ICSE, IB, IGCSE, SSC, competitive exams, languages, and skill-based learning programs.Our mission is to connect students with the most suitable, result-oriented teachers through customized and flexible learning solutions.",
    action: {
      route: "/contact-us",
  ...
  whyChoose: {
    heading: "Why Start Learning with Home TuitionAcademy?",
    description:
      "Home TuitionAcademy, we simplify private education by connecting students with experienced educators and creating personalized, result-focused learning programs that enhance academic performance, build confidence, and support long-term success.",
    reasons: [
      {
        title: "Home TuitionAcademy",
        description:
      ...
      },
      {
        title: "Expert Tutors",
        description:
          "Our team includes experienced and carefully selected tutors for CBSE, ICSE, IB, IGCSE, State Boards, and competitive exams like JEE, NEET, CET, Olympiads, and more. Every educator is chosen based on subject expertise, teaching quality, communication skills, and student-friendly approach.",
        // items: [
      ...
      },
      {
        ...
        //   "Helping businesses grow with digital transformation",
        // ],
      },
    ],
  },
  ...
  recommendation: {
    ...
    description:
      "Finding a reliable tutor was difficult until I joined Home TuitionAcademy. The classes are flexible, comfortable, and personalized according to my learning speed. I highly recommend their services to students",
    // features: ["A True Partner", "A Catalyst for Growth", "Scalable Solutions"],
    reviews: [
      {
        review:
          "Since joining Home TuitionAcademy, my confidence in Science and Mathematics has grown tremendously. The tutor's clear explanations and practical teaching methods made learning enjoyable and effective",
        name: "Ramesh",
      ...
      {
        review:
          "Home TuitionAcademy helped me find the right tutor within just a few days. The service was affordable, and I could choose a tutor that matched both my academic needs and budget.",
        name: "Priya",
        designation: "Entrepreneur",
        avatar: null,
      },
      {
        review: " Finding a reliable and experienced tutor at a reasonable cost was challenging until I discovered Home TuitionAcademy. Their quick tutor-matching process saved me time and provided excellent value for money",
        name: "Rajiv",
  ...
  portfolio: {
    heading: "A Showcase of Our Flagship Projects",
    description:
      "We thrive on challenges—they fuel our creativity and drive us to push boundaries. Our case studies showcase how we've partnered with forward-thinking clients to tackle complex problems and deliver innovative, next-generation solutions.",
    action: {
  ...
  workplace: {
    heading: "Why Parents & Students Choose Home TuitionAcademy ",
    description:
      "Quick & Hassle-Free Teacher Search with Perfectly Matched, Qualified & Result-Oriented Tutors from Nearby Areas.",
    body: (
      <>
        Personalized Teacher Selection Based on Board, Class, Subject, Learning Style & Academic Performance Requirements..
        <br />
        <br />
        Join our global mission to collaborate, create, and solve critical
  ...
  ctaOne: {
   ...
   " We’d love to hear about your child's learning goals and explore how we can build a brighter academic future together."
    ,
    action: {
  ...
  faqs: [
    {
      question: "What is Home TuitionACADEMY?",
      answer:
    ...
    {
      question: "Which boards and curriculum do you cover?",
      answer:
    ...
    },
    {
      ...
      answer:
        "We match tutors based on class, board, subjects, timings, budget, and preferred location.",
    },
    {
      question: "Are trial classes available?",
      answer:
        "Yes, trial sessions may be available depending on tutor and subject requirements.",
    },
    {
      question: "Do you guarantee academic results?",
      answer:
        "No. Student performance depends on learning ability, consistency, attendance, and effort",
    },
    {
      question: "Can I request a tutor replacement?",
      answer:
        "Yes, replacement requests may be considered based on genuine concerns and tutor availability.",
    },
    {
      question:
        "Do you provide tutors for competitive exams?",
      answer:
        "Yes, we assist with tutors and trainers for various competitive and entrance examinations",
    },
    {
    ...
    {
      question: "How can I contact Home TuitionAcademy?",
      answer:
