    ...
    list: [
      {
        ...
        title: "Knowledge",
        description:
          "Every project reflects our commitment to excellence—imbued with the 'Home Tuition Starmark' of quality. From seamless communication to strategic decisions and cutting-edge solutions, we set the highest standards, powered by our unmatched technological expertise.",
      },
      {
        icon: (
          <svg
    ...
    <main className="w-full  pt-[16%] sm:pt-[12%] xl:pt-[7%] pb-16">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex items-center md:pl-5 md:border-l border-grayBorder">
              <p className="text-sm sm:text-base text-black text-center sm:text-start">
                Since 2015, Home Tuition has delivered proven software solutions
      ...
      <div className="container py-7 sm:py-10 lg:py-16 xl:py-20 px-5  lg:px-2">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:items-center">
          ...
          <div className="flex items-center md:pl-5 md:border-l border-grayBorder">
            <p className="text-sm sm:text-base text-black text-center sm:text-start">
              Home Tuition is a global leader in custom enterprise software,
