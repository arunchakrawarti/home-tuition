...
const TermPage = () => {
  return (
    <section className="w-full px-5 sm:px-2 py-[30%] sm:py-[20%] xl:py-[7%]">
      <div
      ...
      >
        ...
        <h3>Terms and Conditions – Home TuitionAcademy</h3>

        <p>
          Welcome to Home TuitionAcademy. These Terms and Conditions govern
        ...
        <p>
          By engaging with Home TuitionAcademy, students, parents,
        ...
        <p>
          Home TuitionAcademy provides assistance for:
        </p>
        ...
        <ul>
          ...
          <li>
            Inform Home TuitionAcademy of any concerns regarding assigned
            tutors.
          </li>
        </ul>
        ...
        <p>
          Tutors associated with Home TuitionAcademy are expected to:
        </p>
        ...
        <p>
          Home TuitionAcademy reserves the right to discontinue association
        ...
        <p>
          Home TuitionAcademy endeavors to provide suitable tutor
        ...
        <p>
          ...
          fees must be paid as communicated by Home TuitionAcademy.
        </p>
        ...
        <ul>
          ...
          <li>
            Home TuitionAcademy reserves the right to revise fees without
        ...
        <p>
          Home TuitionAcademy may attempt to provide a replacement tutor
        ...
        <p>
          While Home TuitionAcademy strives to connect students with
          qualified educators:
        </p>
        ...
        <p>
          Home TuitionAcademy acts primarily as a facilitator connecting
          students and tutors.
        </p>

        <p>
          Home TuitionAcademy shall not be held liable for:
        </p>
        ...
        <ul>
          ...
          <li>
            Defame Home TuitionAcademy, its staff, tutors, or associated
            parties.
          </li>
        ...
        <p>
          ...
          Academy remain the exclusive property of Home TuitionAcademy.
        </p>
        ...
        <p>
          Use of Home TuitionAcademy services is also governed by our
        ...
        <p>
          Home TuitionAcademy shall not be responsible for delays or
        ...
        <p>
          Home TuitionAcademy reserves the right to update, amend, or
        ...
        <p>
          ...
          contact Home TuitionAcademy through its official communication
          channels.
        </p>
        ...
        <p>
          By using the services of Home TuitionAcademy, the user
